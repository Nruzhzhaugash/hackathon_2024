    ...
    >
      ...
      >
        <motion.h2
          ...
          custom={0.8}
          className="mmd:text-[16px] text-2xl mb-[80px] font-keetanoKB"
        >
        ...
        >
          ...
          <div className="w-[630px]">
            <motion.h3
              ...
              custom={1}
              className="text-xl mb-[50px] mmd:text-[12px]"
            >
              СЕКРЕТЫ ИГРЫ МАФИЯ
            </motion.h3>
            <motion.p
              variants={textAnimation}
              custom={2}
              className="mmd:text-[7px] text-base font-involveBQ"
            >
        ...
        >
          <div className="w-[630px]">
            <motion.h3
              variants={textAnimation2}
              custom={1}
              className="mmd:text-[12px] text-xl mb-[50px]"
            >
